...
### 						                         Отчёт по лабораторной работе № 4 <br/>					  
...
#Вывод: <br/>
В данной лабораторной работе освоили методы составления многофайловых программ, закрепили навыки работы со структурами и перечислениями.<br/> 
Необходимо было создать игру "Иксики-нолики", основной функционал написать в вспомогательном файле. 
